...
import * as echarts from 'echarts' // 导入echarts包

import NProgress from 'nprogress' // 导入nprogress包
...
app.use(ElementPlus) //全部挂载ElementPlus
app.use(router)
// app.use(echarts) //全部挂载echarts
app.mount('#app')
...
app.config.globalProperties.$echarts = echarts // 将echarts导入为全局配置，通过this.$echarts/ctx.$echarts进行使用
