    ...
    <div>
        ...
        <el-card class="box-card">
            <el-row :gutter="20">
                ...
                <el-col :span="6">
                    <el-button type="primary" @click="addVisible">添加用户</el-button>
                </el-col>
            </el-row>
            <!-- 用户列表区 -->
            <el-table :data="userList" border stripe>
                ...
                <el-table-column label="操作" width="175px">
                    <template #="{ row }">
                        <!-- 修改按钮 -->
                        <el-button type="primary" icon="el-icon-edit" size="mini" @click="modifyVisible(row)"></el-button>
                        <!-- 删除按钮 -->
                        <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteUserById(row)"></el-button>
                        <!-- 分配角色按钮 -->
                        <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
                            <el-button type="warning" icon="el-icon-setting" size="mini" @click="deployVisible(row)"></el-button>
                        </el-tooltip>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <!-- 添加用户对话框 -->
        <el-dialog title="添加用户" v-model="addDialogVisible" width="50%" @close="addFormClose">
        ...
        <!-- 修改用户对话框 -->
        <el-dialog title="修改用户" v-model="modifyDialogVisible" width="50%" @close="modifyFormClose">
        ...
        <el-dialog title="分配角色" v-model="deployDialogVisible" width="50%" @close="deployRoleClose">
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="deployRole">确 定</el-button>
                </span>
            </template>
        </el-dialog>
    </div>
