        ...
        <el-card>
            ...
            <el-table :data="orderList" border stripe>
                ...
                >
                    <template #="{ row }">
                        <el-tag type="success" v-if="row.pay_status === '1'"
                            >已付款</el-tag
                        >
                        <el-tag type="danger" v-if="row.pay_status === '0'"
                            >未付款</el-tag
                        >
                    </template>
                </el-table-column>
                <el-table-column label="是否发货" prop="is_send" width="80px">
                    <template #="{ row }">
                        <el-tag type="success" v-if="row.is_send === '是'"
                            >已发货</el-tag
                        >
                        <el-tag type="danger" v-if="row.is_send === '否'"
                            >未发货</el-tag
                        >
                    </template>
                </el-table-column>
        ...
        <el-dialog title="修改地址" v-model="addressVisible" width="50%" @close="modifyAddressDialogclosed">
            ...
            >
                <el-form-item label="省市区/县" prop="address1">
                    <el-cascader :options="cityDataList"  :props="cascaderProps" v-model="addressForm.address1"></el-cascader
                ></el-form-item>
