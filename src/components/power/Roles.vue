                ...
                <el-table-column type="expand">
                    <template #="{ row }">
                        <el-row
                            ...
                            v-for="(item01, index01) in row.children"
                            :key="item01.id"
                        >
                            <!-- 渲染一级权限 -->
                            <el-col :span="5"
                                ><el-tag
                                    closable
                                    @close="romoveRightById(row, item01.id)"
                                    >{{ item01.authName }}</el-tag
