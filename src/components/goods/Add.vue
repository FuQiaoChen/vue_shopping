<template>
  <div>
    ...
    <el-card>
      <el-alert title="添加商品信息" type="info" effect="dark" center :closable="false"> </el-alert>
        ...
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTabLeave" @tab-click="tabClick">
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品分类" prop="goods_cat">
              <el-cascader v-model="addForm.goods_cat" :options="cateList" :props="cascaderProps" @change="CateChange" clearable></el-cascader>
            </el-form-item>
          </el-tab-pane>
  ...
  methods: {
    ...
    addFinish() {
      this.$refs.addFormRef.validate(async valid => {
        if (!valid) {
          return this.$message.error('请填写必要的表单顶')
        }
