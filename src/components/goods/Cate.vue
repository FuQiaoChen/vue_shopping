<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 分类列表区  -->
      <el-tree :data="cateList" :props="defaultProps" node-key="id" @node-click="handleNodeClick" :expand-on-click-node="false">
        <template #default="{ node, data }">
          ...
          >
            ...
            <span>
              <el-button size="mini" type="primary" icon="el-icon-edit" @click="showModifyCate(data)">编辑</el-button>
              <el-button size="mini" type="danger" icon="el-icon-delete" @click="deleteCateById(node, data)">删除</el-button>
            </span>
          </span>
        </template>
      </el-tree>
    ...
    <!-- 添加分类对话框 -->
    <el-dialog title="添加分类" v-model="addCateDialogVisible" width="50%" @close="addCateClose">
      <!-- 添加表单 -->
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          <el-cascader v-model="selectedParentKey" :options="ParentCateList" :props="cascaderProps" @change="parentCateChange" clearable></el-cascader>
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!-- 编辑分类对话框 -->
    <el-dialog title="编辑分类" v-model="modifyCateDialogVisible" width="50%" @close="modifyCateClose">
      <!-- 添加表单 -->
  ...
  methods: {
    ...
    parentCateChange() {
      ...
      if (this.selectedParentKey.length > 0) {
        this.addCateForm.cat_pid = this.selectedParentKey[this.selectedParentKey.length - 1]
